...
export class TurnoService {
  ...
  return this.http.post('http://localhost:8080/api/turnos', turno, {
    responseType: 'text'
  });
  }
  ...
  return this.http.get<Turno>('http://localhost:8080/api/turnos/proximo', { observe: 'response' }).pipe(
  ...
  return this.http.put<void>(`http://localhost:8080/api/turnos/${id}/cancelar-paciente`, {});
  }
